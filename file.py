...
from metric import dice_loss, dice_coef, iou
...
if __name__ == "__main__":
    ...
    """ Load the dataset """
    data_x = glob(r"C:\Users\Alisha\PycharmProjects\machine learning\remove_background\girl.jpg")
    ...
    for path in tqdm(data_x, total=len(data_x)):
         ...
         cv2.imwrite("remove_bg/{black}.png",image * photo_mask )
         ...
         cv2.imwrite("remove_bg/{white}.png", final_photo)